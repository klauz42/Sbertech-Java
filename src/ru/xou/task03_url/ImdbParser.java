...
public class ImdbParser {
    public static void main(String[] args) throws Exception {
        ...
        File file = new File(pathToSavingFile = String.format("/home/claus/testdir/imdb/%s%s", firstName, secName));
...
class Producer extends PersonType{

}

class Self extends PersonType {
